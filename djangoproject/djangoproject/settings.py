...
APP_PATH = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'match')
...
SECRET_KEY = '!&f=83^e8#65hk46uk3fn=ee#qh0z^i86k7c9py06_n*t=j6#!'
...
# To serve static files in development set debugging to True
